...
// biome-ignore lint/suspicious/noExplicitAny: Untyped JSON-LD data from third-party HTML
...
export function extractOgTags($: cheerio.CheerioAPI): Record<string, string> {
